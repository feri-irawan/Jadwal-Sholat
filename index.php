...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Lihat jadwal sholat, jadwal imsak dan buka puasa terbaru di daerahmu tiap hari.">
  ...
  <body>
    ...
    <section class="container">
      <form class="mb-3" action="" method="get">
        ...
        <div class="row">
          <div class="col-6">
            Sekarang pukul: <div id="time"></div>
          </div>
          <div class="col-6">
            <div class="text-end">
    ...
    function getTimeNow() {
      ...
      let fullTime = current.toLocaleTimeString();
